...
import { ColorPicker } from './ColorPicker.styles-api.js';
...
const ColorInput = __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, Input), InputWrapper), ColorPicker), {
