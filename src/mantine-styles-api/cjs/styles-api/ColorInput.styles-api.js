...
const ColorInput = __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, Input_stylesApi.Input), InputWrapper_stylesApi.InputWrapper), ColorPicker_stylesApi.ColorPicker), {
