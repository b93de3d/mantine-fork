...
import { useMantineTheme, Box, Text, ActionIcon, Tooltip, Button } from '@mantine/core';
...
function Demo() {
  const [opened, setOpened] = useState(true);
  const theme = useMantineTheme();
  const tooltip = /* @__PURE__ */ React.createElement(Box, {
    sx: { display: "flex", marginRight: -5 },
    mr: -5
  }, /* @__PURE__ */ React.createElement(Text, {
    size: "xs",
    sx: { color: theme.colorScheme === "dark" ? theme.colors.dark[9] : theme.white }
  }, "Use this button to save this information in your profile, after that you will be able to access it any time and share it via email."), /* @__PURE__ */ React.createElement(ActionIcon, {
    variant: "transparent",
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Box, {
    ...
    onClick: () => setOpened(false)
  }, "Save to profile")), !opened && /* @__PURE__ */ React.createElement(Button, {
    variant: "light",
    mt: "xs",
    onClick: () => setOpened(true)
  }, "Reopen tooltip")));
