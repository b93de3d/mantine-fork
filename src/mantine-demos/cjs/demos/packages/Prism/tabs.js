...
`;
function Demo() {
  return /* @__PURE__ */ React__default.createElement(prism.Prism.Tabs, null, /* @__PURE__ */ React__default.createElement(prism.Prism.Tab, {
    label: "styles.css",
    language: "css",
    icon: /* @__PURE__ */ React__default.createElement(CSSIcon, {
      width: 16,
      height: 16
    })
  }, languages.css), /* @__PURE__ */ React__default.createElement(prism.Prism.Tab, {
    label: "decorator.py",
    language: "python",
    icon: /* @__PURE__ */ React__default.createElement(PythonIcon, {
      width: 16,
      height: 16
    })
  }, languages.py), /* @__PURE__ */ React__default.createElement(prism.Prism.Tab, {
    label: "component.tsx",
    language: "tsx",
    icon: /* @__PURE__ */ React__default.createElement(TsIcon, {
      width: 16,
      height: 16
    })
  }, usage.demoCode.trim()));
