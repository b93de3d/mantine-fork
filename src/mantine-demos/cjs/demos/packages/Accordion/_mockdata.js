...
const baseAccordionMockdata = [
  ...
  },
  {
    ...
    content: "With new :focus-visible pseudo-class focus ring appears only when user navigates with keyboard"
  }
];
...
exports.baseAccordionMockdata = baseAccordionMockdata;
