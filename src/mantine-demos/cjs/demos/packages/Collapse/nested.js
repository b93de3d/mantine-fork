...
function CollapsedDemo(_a) {
  ...
  return /* @__PURE__ */ React__default.createElement("div", {
    ...
    onClick: () => setOpen((o) => !o),
    mb: 5
  }, buttonProps)), /* @__PURE__ */ React__default.createElement(core.Collapse, __spreadValues({
    in: opened
  }, others), children));
}
...
function Demo() {
  return /* @__PURE__ */ React__default.createElement(CollapsedDemo, {
    buttonProps: { children: "Root collapse" }
  }, /* @__PURE__ */ React__default.createElement(core.Text, {
    mt: "md",
    size: "lg",
    weight: 700
  }, "This collapse contains another collapse"), /* @__PURE__ */ React__default.createElement(core.Text, {
    mt: "xs"
  }, lorem), /* @__PURE__ */ React__default.createElement(CollapsedDemo, {
    buttonProps: { variant: "outline", children: "Inner collapse" }
  }, /* @__PURE__ */ React__default.createElement(core.Text, {
    mt: "md",
    size: "lg",
    weight: 700
  }, "This collapse is inside another collapse"), /* @__PURE__ */ React__default.createElement(core.Text, {
    mt: "xs"
  }, lorem)));
}
const nested = {
