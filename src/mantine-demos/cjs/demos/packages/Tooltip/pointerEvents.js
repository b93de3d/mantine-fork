...
function Demo() {
  ...
  const tooltip = /* @__PURE__ */ React__default.createElement(core.Box, {
    sx: { display: "flex", marginRight: -5 },
    mr: -5
  }, /* @__PURE__ */ React__default.createElement(core.Text, {
    size: "xs",
    sx: { color: theme.colorScheme === "dark" ? theme.colors.dark[9] : theme.white }
  }, "Use this button to save this information in your profile, after that you will be able to access it any time and share it via email."), /* @__PURE__ */ React__default.createElement(core.ActionIcon, {
    variant: "transparent",
  ...
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement(core.Box, {
    ...
    onClick: () => setOpened(false)
  }, "Save to profile")), !opened && /* @__PURE__ */ React__default.createElement(core.Button, {
    variant: "light",
    mt: "xs",
    onClick: () => setOpened(true)
  }, "Reopen tooltip")));
