...
`;
const initialValues = [
  _mockdata.charactersList.map((item, index) => __spreadProps(__spreadValues({}, item), { value: index.toString() })),
  []
];
const ItemComponent = ({
  data,
  ...
  size: "sm",
  weight: 500
}, data.label), /* @__PURE__ */ React__default.createElement(core.Text, {
  size: "xs",
  color: "dimmed",
  weight: 400
}, data.description)), /* @__PURE__ */ React__default.createElement(core.Checkbox, {
  checked: selected,
  onChange: () => {
  },
  tabIndex: -1,
